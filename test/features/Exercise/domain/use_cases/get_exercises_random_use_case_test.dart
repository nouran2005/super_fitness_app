...
void main() {
  ...
  test(
    'should call repository.getExercisesRandom and return success result',
    () async {
      ...
      when(
        mockRepository.getExercisesRandom(
  ...
  test('should return error when repository fails', () async {
    when(
      ...
      (_) async => ErrorApiResult(error: 'Failed to fetch random exercises'),
    );
